...
export class MyData {
    ...
    public constructor() {
        ...
        this.listOfMoves=JSON.parse('{"list":[{"source":{"posX":0,"posY":0},"target":{"posX":0,"posY":1}}]}');
    }
    ...
    public receiveListOfMovesJson(json : string){
        console.log(json);
        var js = '{"list":'+JSON.stringify(json)+'}';
        console.log(js);
        this.listOfMoves = JSON.parse(js);
    }
}
